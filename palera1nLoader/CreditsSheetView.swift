...
struct CreditsSheetView: View {
    ...
    var credits: [Person] = [
        Person(name: "Hephaestus/Ironside", icon: URL(string: "https://repo.ironside.org.uk/CydiaIcon.png")!, role: "best loader", link: URL(string: "https://github.com/hephaestus-ironside/")!),
